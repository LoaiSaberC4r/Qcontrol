...
internal sealed class DeactivateBranchAdvertisementCommandValidator
    : AbstractValidator<DeactivateBranchAdvertisementCommand>
{
    public DeactivateBranchAdvertisementCommandValidator()
    {
