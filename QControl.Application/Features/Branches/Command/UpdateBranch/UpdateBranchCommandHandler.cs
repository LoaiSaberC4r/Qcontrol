    ...
    : ICommandHandler<UpdateBranchCommand, UpdateBranchResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result<UpdateBranchResponse>.Fail(
                new Error(
        ...
        return Result<UpdateBranchResponse>.Ok(
            response);
    }
}