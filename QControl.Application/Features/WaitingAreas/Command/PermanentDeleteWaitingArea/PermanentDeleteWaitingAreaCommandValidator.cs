...
internal sealed class PermanentDeleteWaitingAreaCommandValidator
    : AbstractValidator<PermanentDeleteWaitingAreaCommand>
{
    public PermanentDeleteWaitingAreaCommandValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
