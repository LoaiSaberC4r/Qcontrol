...
internal sealed class GetDeletedTerminalsSpec
    : Specification<Terminal, DeletedTerminalListItemResponse>
{
    public GetDeletedTerminalsSpec(GetDeletedTerminalsQuery query)
    {
        IgnoreGlobalFilters();
        ...
        Select(x => new DeletedTerminalListItemResponse
        {
            Id = x.Id,
            WindowId = x.WindowId,
