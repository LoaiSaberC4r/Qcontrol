...
internal sealed class ReactivateTerminalCommandHandler
    : ICommandHandler<ReactivateTerminalCommand, ReactivateTerminalResponse>
{
    ...
    public ReactivateTerminalCommandHandler(
    ...
    public async Task<Result<ReactivateTerminalResponse>> Handle(
        ReactivateTerminalCommand request,
        CancellationToken cancellationToken)
    {
        if (!_currentUser.IsAuthenticated || !_currentUser.UserId.HasValue)
        {
            return Result<ReactivateTerminalResponse>.Fail(new Error(
                "Terminals.Reactivate.Unauthenticated",
        ...
        {
            return Result<ReactivateTerminalResponse>.Fail(new Error(
                "Terminals.Reactivate.InvalidRowVersion",
        ...
        {
            return Result<ReactivateTerminalResponse>.Fail(new Error(
                "Terminals.Reactivate.TerminalNotFound",
        ...
        {
            return Result<ReactivateTerminalResponse>.Fail(new Error(
                "Terminals.Reactivate.AlreadyActive",
                ErrorMessage.Terminal_AlreadyActive,
                ErrorType.Conflict));
        }
        ...
        terminal.Reactivate(_dateTimeProvider.UtcNow, _currentUser.UserId.Value);
        ...
        {
            return Result<ReactivateTerminalResponse>.Fail(new Error(
                "Terminals.Reactivate.ConcurrencyConflict",
                ErrorMessage.Concurrency_Conflict,
                ErrorType.Conflict));
        }

        return Result<ReactivateTerminalResponse>.Ok(new ReactivateTerminalResponse
        {
            Id = terminal.Id,
            ...
            Message = ErrorMessage.Terminal_Reactivate_Success
        });
    }
}
