...
internal sealed class UploadServiceLogoImageCommandValidator
    : AbstractValidator<UploadServiceLogoImageCommand>
{
    public UploadServiceLogoImageCommandValidator()
    {
