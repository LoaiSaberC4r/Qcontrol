...
internal sealed class UploadServiceAdsImagesCommandValidator
    : AbstractValidator<UploadServiceAdsImagesCommand>
{
    public UploadServiceAdsImagesCommandValidator()
    {
        ...
        RuleFor(x => x.Images)
            .NotEmpty()
            .WithMessage(ServiceFeatureMessages.ImagesRequired);
    }
}
