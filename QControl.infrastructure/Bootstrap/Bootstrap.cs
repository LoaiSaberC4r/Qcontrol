...
using QControl.infrastructure.Authorization;
using QControl.infrastructure.Options;
using QControl.infrastructure.Persistence;
using QControl.infrastructure.Repositories;
using QControl.infrastructure.Seeders;
using QControl.infrastructure.Services;
    ...
    public static class Bootstrap
    {
        public static IServiceCollection InfrastructureInjection(this IServiceCollection services, IConfiguration configuration)
        {
          ...
          .ValidateOnStart();
            ...
            services.AddScoped<IBranchDisplayMessageReorderRepository, BranchDisplayMessageReorderRepository>();
        ...
        {
            services.AddScoped<ISeeder, TechnicalAdminSeeder>();
