...
namespace Qcontrol.Infrastructure.Migrations
{
    ...
    [Migration("20260625084600_AddWindowManagementAndSoftDelete")]
    partial class AddWindowManagementAndSoftDelete
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Terminal", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Terminal_Number_Positive", "[Number] > 0");
                        });
                });
