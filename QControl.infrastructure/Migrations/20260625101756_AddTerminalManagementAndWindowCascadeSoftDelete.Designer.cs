...
namespace Qcontrol.Infrastructure.Migrations
{
    ...
    [Migration("20260625101756_AddTerminalManagementAndWindowCascadeSoftDelete")]
    partial class AddTerminalManagementAndWindowCascadeSoftDelete
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Display", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Display_Number_Positive", "[Number] > 0");
                        });
                });
